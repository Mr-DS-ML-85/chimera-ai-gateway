...
from core.config import GATEWAY_VERSION, MAX_BODY_BYTES, WAF_RULE_VERSION, CHIMERA_API_KEY, JWKS_URI, CUSTOM_MODEL_ALIASES
...
async def anthropic_messages(request: Request):
    ...
    """
    from providers.anthropic_client import is_configured as anthropic_is_configured
    ...
    model_aliases = {
        # Anthropic model shortcuts → route through gateway, NOT direct
        "sonnet": "google/gemini-3.1-flash-lite",
        "sonnet-4-7": "google/gemini-3.1-flash-lite",
        "haiku": "google/gemini-3.1-flash-lite",
        "opus": "opencode-zen/minimax-m2.5-free",
        "3.5-haiku": "google/gemini-3.1-flash-lite",
        "3.5-sonnet": "google/gemini-3.1-flash-lite",
        ...
        # gemini-3-flash → routes via official Google provider (aistudio.google.com)
        "gemini-3-flash": "google/gemini-3-flash-preview-05-20",
        "gemini-3-flash-preview": "google/gemini-3-flash-preview-05-20",
        # gemini-3.1-flash-lite → aliased as claude-4.6-sonnet
        "gemini-3.1-flash-lite": "google/gemini-3.1-flash-lite",
        "claude-4.6-sonnet": "google/gemini-3.1-flash-lite",
        "sonnet-4.6": "google/gemini-3.1-flash-lite",
    ...
    if raw_alias in model_aliases:
        ...
        body["model"] = requested_model  # Update body so translation uses aliased model
    ...
    if requested_model.startswith("anthropic/") and anthropic_is_configured():
        from providers.anthropic_client import call_messages, stream_messages
